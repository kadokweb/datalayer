...
[![Source Code](http://img.shields.io/badge/source-kadokweb/datalayer-blue.svg?style=flat-square)](https://github.com/kadokweb/datalayer)
[![PHP from Packagist](https://img.shields.io/packagist/php-v/KadokWeb/datalayer.svg?style=flat-square)](https://packagist.org/packages/kadokweb/datalayer)
[![Latest Version](https://img.shields.io/github/release/kadokweb/datalayer.svg?style=flat-square)](https://github.com/kadokweb/datalayer/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE)
[![Build](https://img.shields.io/scrutinizer/build/g/kadokweb/datalayer.svg?style=flat-square)](https://scrutinizer-ci.com/g/kadokweb/datalayer)
[![Quality Score](https://img.shields.io/scrutinizer/g/kadokweb/datalayer.svg?style=flat-square)](https://scrutinizer-ci.com/g/kadokweb/datalayer)
[![Total Downloads](https://img.shields.io/packagist/dt/kadokweb/datalayer.svg?style=flat-square)](https://packagist.org/packages/kadokweb/datalayer)
...
###### KadokWeb is a set of small and optimized PHP components for common tasks. Held by Doka Silva and the Kadok team. With them you perform routine tasks with fewer lines, writing less and doing much more.

KadokWeb é um conjunto de pequenos e otimizados componentes PHP para tarefas comuns. Mantido por Doka Silva e a equipe Kadok. Com eles você executa tarefas rotineiras com poucas linhas, escrevendo menos e fazendo muito mais.
...
```bash
"kadokweb/datalayer": "1.0.*"
```

or run

```bash
composer require kadokweb/datalayer
```
...
```php
$params = http_build_query(["name" => "Kadok & Associated"]);
...
echo $this->full_name; //Doka Silva
echo $this->document; //Restrict
```

## Contributing

Please see [CONTRIBUTING](https://github.com/kadokweb/datalayer/blob/master/CONTRIBUTING.md) for details.
...
- [All Contributors](https://github.com/kadokweb/datalayer/contributors) (This Rock)

## License

The MIT License (MIT). Please see [License File](https://github.com/kadokweb/datalayer/blob/master/LICENSE) for more information.
